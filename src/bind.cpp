...
public:
  ...
  void add_ghost(const double &displacement_module,
                 const std::string &direction) override {
    PYBIND11_OVERRIDE(void, particles_4d, add_ghost, displacement_module,
                      direction);
  }
  ...
  get_displacement_module() const override {
    PYBIND11_OVERRIDE(const std::vector<std::vector<double>>, particles_4d,
                      get_displacement_module, );
  }
  const std::vector<std::vector<std::vector<double>>>
  get_displacement_direction() const override {
    PYBIND11_OVERRIDE(const std::vector<std::vector<std::vector<double>>>,
                      particles_4d, get_displacement_direction);
  }
  ...
  const std::vector<int> get_steps() const override {
    PYBIND11_OVERRIDE(const std::vector<int>, particles_4d, get_steps);
  }
...
struct py_henon_tracker : public henon_tracker {
  ...
  void compute_a_modulation(unsigned int N, double omega_x, double omega_y,
                            std::string modulation_kind = "sps",
                            double omega_0 = NAN, double epsilon = 0.0,
                            int offset = 0) override {
    PYBIND11_OVERRIDE(void, henon_tracker, compute_a_modulation, N, omega_x,
                      omega_y, modulation_kind, omega_0, epsilon, offset);
  }
};
...
struct py_henon_tracker_gpu : public henon_tracker_gpu {
  ...
  void compute_a_modulation(unsigned int N, double omega_x, double omega_y,
                            ...
                            double omega_0 = NAN, double epsilon = 0.0,
                            int offset = 0) override {
    PYBIND11_OVERRIDE(void, henon_tracker_gpu, compute_a_modulation, N, omega_x,
                      omega_y, modulation_kind, omega_0, epsilon, offset);
  }
};
...
PYBIND11_MODULE(henon_map_engine, m) {
  ...
  m.def("basic_modulation", &basic_modulation, "Basic modulation",
        ...
        py::arg("end"));
  m.def("sps_modulation", &sps_modulation, "SPS modulation", py::arg("tune"),
        py::arg("epsilon"), py::arg("start"), py::arg("end"));
  ...
  m.def("birkhoff_weights", &birkhoff_weights, "Birkhoff weights",
        py::arg("n_weights"));

  m.def("get_tunes", &get_tunes, "Get tunes", py::arg("x"), py::arg("px"));
  ...
  py::class_<matrix_4d_vector>(m, "matrix_4d_vector")
      ...
      .def("structured_multiply",
           static_cast<void (matrix_4d_vector::*)(
               const henon_tracker &, const particles_4d &, const double &,
               const bool &)>(&matrix_4d_vector::structured_multiply),
           py::arg("tracker"), py::arg("particles"), py::arg("mu"),
           py::arg("reverse"))
    //   .def("structured_multiply",
    //        static_cast<void (matrix_4d_vector::*)(
    //            const henon_tracker_gpu &, const particles_4d_gpu &,
    //            const double &, const bool &)>(
    //            &matrix_4d_vector::structured_multiply),
    //        py::arg("tracker"), py::arg("particles"), py::arg("mu"),
    //        py::arg("reverse"))
      .def("get_matrix",
           [](matrix_4d_vector &self) {
  ...
  py::class_<matrix_4d_vector_gpu>(m, "matrix_4d_vector_gpu")
      ...
      .def("structured_multiply", &matrix_4d_vector_gpu::structured_multiply,
           py::arg("tracker"), py::arg("particles"), py::arg("mu"))
      .def("set_with_tracker", &matrix_4d_vector_gpu::set_with_tracker,
           py::arg("tracker"), py::arg("particles"), py::arg("mu"))
      .def("explicit_copy", &matrix_4d_vector_gpu::explicit_copy,
           py::arg("other"))
      .def("get_matrix",
           [](matrix_4d_vector_gpu &self) {
             py::array out = py::cast(self.get_matrix());
             return out;
           })
      .def(
  ...
  py::class_<vector_4d_gpu>(m, "vector_4d_gpu")
      ...
      .def("set_vectors",
           static_cast<void (vector_4d_gpu::*)(
               const std::vector<std::vector<double>> &)>(
               &vector_4d_gpu::set_vectors),
           py::arg("vectors"))
      .def("set_vectors",
           static_cast<void (vector_4d_gpu::*)(const std::vector<double> &)>(
               &vector_4d_gpu::set_vectors),
           py::arg("vectors"))
  ...
  py::class_<lyapunov_birkhoff_construct>(m, "lyapunov_birkhoff_construct")
      ...
      .def("change_weights", &lyapunov_birkhoff_construct::change_weights,
           py::arg("n_weights"))
      .def("add", &lyapunov_birkhoff_construct::add, py::arg("vectors"))
      .def("get_weights",
           [](lyapunov_birkhoff_construct &self) {
  ...
  py::class_<lyapunov_birkhoff_construct_multi>(
      m, "lyapunov_birkhoff_construct_multi")
      ...
      .def("get_values_raw",
           [](lyapunov_birkhoff_construct_multi &self) {
             py::array out = py::cast(self.get_values_raw());
             return out;
           })
  ...
  py::class_<megno_construct>(m, "megno_construct")
      ...
      .def("add", &megno_construct::add, py::arg("matrix_a"),
           py::arg("matrix_b"))
  ...
  py::class_<megno_birkhoff_construct>(m, "megno_birkhoff_construct")
      ...
      .def("add", &megno_birkhoff_construct::add, py::arg("matrix_a"),
           py::arg("matrix_b"))
  ...
  py::class_<tune_birkhoff_construct>(m, "tune_birkhoff_construct")
      ...
      .def("first_add", &tune_birkhoff_construct::first_add,
           py::arg("particles"))
      .def("add", &tune_birkhoff_construct::add, py::arg("particles"))
      .def("get_tune1_x",
           [](tune_birkhoff_construct &self) {
  ...
  py::class_<henon_tracker, py_henon_tracker>(m, "henon_tracker")
      .def(py::init<unsigned int, double, double, std::string, double, double,
                    unsigned int>())
      .def("compute_a_modulation", &henon_tracker::compute_a_modulation,
           "Compute a modulation", py::arg("N"), py::arg("omega_x"),
           py::arg("omega_y"), py::arg("modulation_kind"), py::arg("omega_0"),
           py::arg("epsilon"), py::arg("offset"))
      .def("track", &henon_tracker::track, "Track particles",
           py::arg("particles"), py::arg("n_turns"), py::arg("mu"),
           py::arg("barrier") = 100.0, py::arg("kick_module") = NAN,
           py::arg("inverse") = false)
      .def("megno", &henon_tracker::megno, "Compute megno",
           py::arg("particles"), py::arg("n_turns"), py::arg("mu"),
           py::arg("barrier") = 100.0, py::arg("kick_module") = NAN,
           py::arg("inverse") = false,
           py::arg("turn_samples") = std::vector<unsigned int>(),
           py::arg("n_threads") = -1)
      .def("birkhoff_tunes", &henon_tracker::birkhoff_tunes,
           "Compute birkhoff tunes", py::arg("particles"), py::arg("n_turns"),
           py::arg("mu"), py::arg("barrier") = 100.0,
           py::arg("kick_module") = NAN, py::arg("inverse") = false,
           py::arg("from_idx") = std::vector<unsigned int>(),
           py::arg("to_idx") = std::vector<unsigned int>())
      .def("all_tunes", &henon_tracker::all_tunes, "Compute birkhoff tunes",
           py::arg("particles"), py::arg("n_turns"), py::arg("mu"),
           py::arg("barrier") = 100.0, py::arg("kick_module") = NAN,
           py::arg("inverse") = false,
           py::arg("from_idx") = std::vector<unsigned int>(),
      ...
      .def(
          "get_tangent_matrix",
          [](henon_tracker &self, const particles_4d &particles,
             const double &mu, const bool &reverse) {
            py::array out =
                py::cast(self.get_tangent_matrix(particles, mu, reverse));
            return out;
          },
  ...
  py::class_<henon_tracker_gpu, py_henon_tracker_gpu>(m, "henon_tracker_gpu")
      ...
      .def("compute_a_modulation", &henon_tracker_gpu::compute_a_modulation,
           ...
           py::arg("omega_y"), py::arg("modulation_kind"), py::arg("omega_0"),
           py::arg("epsilon"), py::arg("offset"))
      .def("track", &henon_tracker_gpu::track, "Track particles",
           py::arg("particles"), py::arg("n_turns"), py::arg("mu"),
           py::arg("barrier") = 100.0, py::arg("kick_module") = NAN,
           py::arg("inverse") = false)
      .def(
          "get_tangent_matrix",
          [](henon_tracker_gpu &self, const particles_4d_gpu &particles,
             const double &mu, const bool &reverse) {
            py::array out =
                py::cast(self.get_tangent_matrix(particles, mu, reverse));
            return out;
  ...
  py::class_<storage_4d>(m, "storage_4d")
      .def(py::init<size_t>())
      .def("store",
           static_cast<void (storage_4d::*)(const particles_4d &)>(
               &storage_4d::store),
           "Store particles")
      // .def("store",
      //      static_cast<void (storage_4d::*)(const particles_4d_gpu &)>(
      //          &storage_4d::store),
      //      "Store particles")
      .def("tune_fft", &storage_4d::tune_fft, "Tune FFT", py::arg("from_idx"),
           py::arg("to_idx"))
      .def("tune_birkhoff", &storage_4d::tune_birkhoff, "Tune birkhoff",
           py::arg("from_idx"), py::arg("to_idx"))
  ...
  py::class_<storage_4d_gpu>(m, "storage_4d_gpu")
      .def(py::init<size_t, size_t>())
      .def("store", &storage_4d_gpu::store, "Store particles",
           py::arg("particles"))
