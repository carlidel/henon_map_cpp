...
class storage():
    ...
    def tune_fft(self, from_idx, to_idx):
        return np.asarray(self.storage.tune_fft(from_idx, to_idx))

    def tune_birkhoff(self, from_idx, to_idx):
        return np.asarray(self.storage.tune_birkhoff(from_idx, to_idx))
